...
import SingleRequest from '../../organization/single_regest/SingleRequest';
class RequestList extends Component {
  ...
  changeStatus = (index) => {
    this.state.dataList[index].item.requestStatus = !this.state.dataList[index].item.requestStatus;
    this.setState({extendedState:this.state.dataList[index].item.requestStatus})
  }


//row render single item
  rowRenderer = (type, data, index,extendedState) => {
    const {productName,DateOfPurchase,productImage,requestStatus} = data.item
    return (
      <SingleRequest
