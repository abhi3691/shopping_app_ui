  ...
  return (
    <View style={styles.container}>
      {iconName === 'home-filled' ? (
        <HomeIconFIlled height={FontRatio(18)} width={FontRatio(18)} />
      ) : iconName === 'home' ? (
        <HomeIcon height={FontRatio(18)} width={FontRatio(18)} />
      ) : iconName === 'notifications-filled' ? (
        <NotificationIconFilled height={FontRatio(18)} width={FontRatio(18)} />
      ) : iconName === 'notifications' ? (
        <NotificationIcon height={FontRatio(18)} width={FontRatio(18)} />
      ) : iconName === 'cart-filled' ? (
        <CartIconFilled height={FontRatio(22)} width={FontRatio(22)} />
      ) : iconName === 'cart' ? (
        <CartIcon height={FontRatio(22)} width={FontRatio(22)} />
      ) : iconName === 'person-filled' ? (
        <PersonIconFilled height={FontRatio(18)} width={FontRatio(18)} />
      ) : iconName === 'person' ? (
        <PersonIcon height={FontRatio(18)} width={FontRatio(18)} />
      ) : (
        <HomeIcon height={FontRatio(18)} width={FontRatio(18)} />
      )}
